...
const credentials = [
  ...
  },
  {
    ...
    description:
      "Secured dream university places. Students jump 2+ grades in weeks, not months.",
  },
  {
    icon: Trophy,
    stat: "A*",
...
const faqItems = [
  ...
  {
    question:
      "Does it matter if I take Statistics, Mechanics, or Decision Maths?",
    answer:
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mt-4">
                If you're ready to plug gaps and master exam technique fast,
                this is for you. However, if you're missing foundational
                concepts, we drill it immediately. I bridge your knowledge gaps
                in minutes, so we can get back to the only thing that matters:
                securing your marks.
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="max-w-4xl mx-auto">
                ...
                >
                  <Card className="border-border bg-card hover:border-foreground/20 transition-all">
                    <CardContent className="p-6">
                      <div className="text-foreground text-4xl font-bold mb-2">
                        {item.stat}
                      </div>
            ...
            >
              <p className="text-xl md:text-2xl text-foreground font-semibold mb-4">
                "I know the stress of the grind. I've refined a method to
                eliminate the guesswork."
              </p>
              <p className="text-lg text-muted-foreground">
                I'm not just a tutor; I'm a diagnostic specialist who identifies
                hidden gaps and saves your time. I've decoded the mark schemes,
                mastered examiner tricks, and identified patterns where students
                leak marks. My students don't just study -- they perform under
                pressure and secure top-tier grades.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.1, ease: circInOut }}
            >
              Don't just take my word for it — hear from students who've
